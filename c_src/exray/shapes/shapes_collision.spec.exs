...
spec(
  check_collision_circle_rec(center :: exVector2, radius :: float, rec :: exRectangle) ::
    colliding :: bool
)
...
spec(
  check_collision_point_circle(point :: exVector2, center :: exVector2, radius :: float) ::
    colliding :: bool
)
...
spec(
  check_collision_lines(
    start_pos_1 :: exVector2,
    end_pos_1 :: exVector2,
    start_pos_2 :: exVector2,
    end_pos_2 :: exVector2,
    collision_point :: [exVector2]
  ) :: colliding :: bool
)
