...
spec(
  draw_spline_segment_linear(p1 :: exVector2, p2 :: exVector2, thick :: float, color :: exColor) ::
    :ok
)
...
spec(
  get_spline_point_linear(start_pos :: exVector2, end_pos :: exVector2, t :: float) ::
    point :: exVector2
)
...
spec(
  get_spline_point_bezier_quad(p1 :: exVector2, c2 :: exVector2, p3 :: exVector2, t :: float) ::
    point :: exVector2
)
