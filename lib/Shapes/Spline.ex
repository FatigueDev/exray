defmodule Exray.Shapes.Spline do
  ...
  """
  @spec get_spline_point_linear(start_pos :: Vector2, end_pos :: Vector2, t :: float) :: {:ok, point :: Vector2}
  defdelegate get_spline_point_linear(start_pos, end_pos, t), to: @loader

  @doc """
  Get (evaluate) spline point: B-Spline
  """
  @spec get_spline_point_basis(p1 :: Vector2, p2 :: Vector2, p3 :: Vector2, p4 :: Vector2, t :: float) :: {:ok, point :: Vector2}
  defdelegate get_spline_point_basis(p1, p2, p3, p4, t), to: @loader

  @doc """
  Get (evaluate) spline point: Catmull-Rom
  """
  @spec get_spline_point_catmull_rom(p1 :: Vector2, p2 :: Vector2, p3 :: Vector2, p4 :: Vector2, t :: float) :: {:ok, point :: Vector2}
  defdelegate get_spline_point_catmull_rom(p1, p2, p3, p4, t), to: @loader

  @doc """
  Get (evaluate) spline point: Quadratic Bezier
  """
  @spec get_spline_point_bezier_quad(p1 :: Vector2, c2 :: Vector2, p3 :: Vector2, t :: float) :: {:ok, point :: Vector2}
  defdelegate get_spline_point_bezier_quad(p1, c2, p3, t), to: @loader

  @doc """
  Get (evaluate) spline point: Cubic Bezier
  """
  @spec get_spline_point_bezier_cubic(p1 :: Vector2, c2 :: Vector2, c3 :: Vector2, p4 :: Vector2, t :: float) :: {:ok, point :: Vector2}
