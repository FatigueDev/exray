defmodule Exray.Core.Drawing do
  ...
  """
  @spec begin_mode_2d(camera :: Camera2D) :: :ok
  ...
  """
  @spec begin_mode_3d(camera :: Camera3D) :: :ok
  ...
  """
  @spec begin_texture_mode(target :: RenderTexture) :: :ok
  ...
  """
  @spec begin_shader_mode(shader :: Shader) :: :ok
